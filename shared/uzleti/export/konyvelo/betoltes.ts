...
export const BETOLTES: Record<Program, readonly string[]> = {
  ...
  kulcs: [
    ...
    'Egy új vevőt vagy szállítót a Kulcs első alkalommal párosíttat (Adategyeztetés): válaszd ki vagy vedd fel, és pipáld be a „Továbbiakban erre cserélje le…” lehetőséget – utána megjegyzi.',
